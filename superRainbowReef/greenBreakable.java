...
import static superRainbowReef.GameState.greenBreakable1;

/**
 *
 * @author handa
 */
public class greenBreakable extends Creature {
    
    protected boolean broken;

    public greenBreakable(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        ...
        if (!broken) {
            g.drawImage(Assets.greenBreakable, (int) getX(), (int) getY(), null);
        }
