 ...
 * @author handa
 */
public class lightblueBreakable extends Creature {

    protected boolean broken;

    public lightblueBreakable(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        ...
        if (!broken) {
            g.drawImage(Assets.lightblueBreakable, (int) getX(), (int) getY(), null);
        }
