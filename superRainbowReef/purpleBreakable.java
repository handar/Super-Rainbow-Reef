 ...
 * @author handa
 */
public class purpleBreakable extends Creature {
    
    protected boolean broken;

    public purpleBreakable(Handler handler, float x, float y) {
   ...
   @Override
    ...
    public void render(Graphics g) {
        ...
        if (!broken) {
            g.drawImage(Assets.purpleBreakable, (int) getX(), (int) getY(), null);
        }
