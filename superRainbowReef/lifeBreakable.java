 ...
 * @author handa
 */
public class lifeBreakable extends Creature {

    protected boolean broken;

    public lifeBreakable(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        ...
        if (!broken) {
            g.drawImage(Assets.lifeBreakable, (int) getX(), (int) getY(), null);
        }
